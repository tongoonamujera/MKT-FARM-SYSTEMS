class CashflowsController < ApplicationController
  ...
  private
    ...
    def cashflow_params
      params.require(:cashflow).permit(:company_name, :date, :season, :month, :grower_name, :hectrage, :operation, :unit_price, :quantity_per_hectre, :unity, :input_name, :total_amount, :user_id, :total_quantity, :tian_ze_number)
    end
end
