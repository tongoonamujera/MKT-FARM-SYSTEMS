class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:email, :Company_Name, :cellphone, :Address, :Category, :status, :Pro_Number, :is_farm_owner, :is_admin, :is_manager, :username, :is_contractor, :is_advertiser)
    end
end
